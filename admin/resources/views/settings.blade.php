									...
									<div class="card">
										<div class="list-group list-group-flush">
											<div class="list-group-item d-flex align-items-center">
												...
												<div class="width-100">
													<a href="#modalEdit" data-bs-toggle="modal" class="btn btn-default width-100">Edit</a>
												</div>
											</div>
											<div class="list-group-item d-flex align-items-center">
												<div class="flex-fill">
									...
									<div class="card">
										<div class="list-group list-group-flush">
											<div class="list-group-item d-flex align-items-center">
												...
												<div>
													<a href="#modalEdit" data-bs-toggle="modal" class="btn btn-default width-100">Manage</a>
												</div>
											</div>
											<div class="list-group-item d-flex align-items-center">
												<div class="flex-fill">
											...
											<div class="list-group-item d-flex align-items-center">
												...
												<div>
													<a href="#modalEdit" data-bs-toggle="modal" class="btn btn-default width-100 disabled">Update</a>
												</div>
											</div>
											<div class="list-group-item d-flex align-items-center">
												<div class="flex-fill">
												...
												<div>
													<a href="#modalEdit" data-bs-toggle="modal" class="btn btn-success width-100">Update</a>
												</div>
											</div>
										</div>
									</div>
