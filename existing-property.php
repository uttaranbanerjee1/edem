                ...
                <div class="left-form-part">
                    <form class="">
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control mt-1" id="inputCurrentRent"
                                    placeholder="Annual Net Rent (current)">
                            </div>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control mt-1" id="inputTargetRent"
                                    placeholder="Annual Net Rent (target)">
                            </div>
                            <div class="form-group col-md-6">
